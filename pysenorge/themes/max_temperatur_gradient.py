...
# Additional
from numpy import zeros, uint16, float32, zeros_like, amax, absolute
try:
...
class Mtg():
    '''
    Loads automatically the nc-file and stores the data in the variable "self.air_temp" 
    '''
    def __init__(self):
    ...
    def model(self,air_temp):
        '''
        Creates a grid of Norway with the maximal temperature gradient of a day. The maximal temperature gradient
        shows how fast temperatures are changed in a day. It is done by calculating the difference of the temperature
